...
namespace ERP.Authority.General
{
    ...
    public class CacheOperation<T> where T : class ,new()
    {
        ...
        public static void SetCache(string key, T t, CacheDependency dependency = null, double minutes = 0, CacheItemPriority priority = CacheItemPriority.Normal, CacheItemRemovedCallback cacheRemoveCallBack = null)
        {
            minutes = minutes == 0 ? WebConfigOperation.CacheTime : minutes;
