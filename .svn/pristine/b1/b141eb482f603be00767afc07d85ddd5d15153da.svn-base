...
namespace ERP.Authority.BLL
{
    public  class Priv_ModuleBLL
    {
        ...
        public ResultModel<object> UpdateEmpPrivilege(Priv_Employee modulePriv,UserInfoForCookie user)
        {
            modulePriv.Modifier = user.EmpCode;
            modulePriv.Creator = user.EmpCode;
            if (string.IsNullOrEmpty(modulePriv.ModulePrivList))
            {
                modulePriv.ModulePrivList = "";
            }
